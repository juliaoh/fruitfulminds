...
Scenario: add new survey results to a new survey record in database
  ...
  And I fill in "s1q1msg" with "Students understand different fruits"
  And I press "Add Question"
  And I should see "Question Name"
  And I fill in "s1q2name" with "Section 1 Question 2"
  And I fill in "s1q2msg" with "Students do not understand anything at all"
  ...
  And I fill in "s2q1msg" with "Students do not agree with anything at all"
