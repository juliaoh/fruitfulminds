module ReportsStaticContent
  def set_static_content
    ...
    @strength_weakness_intro = "Based on the pre- and post-curriculum surveys, as well as feedback from the ambassadors, we identified areas of strength and weakness. Students are identified as competent if 80% or more of them were familiar with topics prior to instruction from Fruitful Minds. Below is a list of strengths, weaknesses, and competencies of the class series:"
    ...
    @increase_header = "The greatest increases in positive student perception showed they were confident in the following areas:"
    @slight_increase_header = "There were slight increases in positive student perception that showed they were confident in the following areas:"
    @decrease_header = "Student confidence decreased the most in the following areas:"
    @slight_decrease_header = "Student confidence slightly decreased in the following areas:"
