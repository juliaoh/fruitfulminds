...
Course.create!({:semester =>"Fall 2013", :total_students=>50, :school_id=>1, :curriculum_id=>1, :presurvey_id=>1, :postsurvey_id=>1, :active => true, :users=>[User.find_by_id(1), User.find_by_id(4)]})
